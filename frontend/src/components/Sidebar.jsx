...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#1E2738] text-slate-300 flex flex-col justify-between border-r border-slate-800 select-none shadow-xl">
      <div>
        {/* Brand Header */}
      ...
      {/* Operator User Card */}
      <div className="p-4 border-t border-slate-700/60 bg-[#171F2E] m-3 rounded-2xl flex items-center justify-between">
        <div className="flex items-center gap-3 overflow-hidden">
          <div className="w-9 h-9 rounded-xl bg-blue-500/20 text-blue-400 border border-blue-500/30 flex items-center justify-center font-black text-xs">
